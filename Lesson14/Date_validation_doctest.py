...
def is_date_valid(date: str) -> bool:
    """
    Check date in format str DD.MM.YYYY Return True if date valid and False if date can't be existed.
    >>> is_date_valid('21.04.1991')
    True
    >>> is_date_valid('30.02.2001')
    False
    >>> is_date_valid('29.02.2300')
    False
    >>> is_date_valid('29.02.2000')
    True
    >>> is_date_valid("It's not date")
    False
    """
